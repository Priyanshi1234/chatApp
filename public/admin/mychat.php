<div class="col-lg-4">
	...
	?>
		<div class="panel-heading"><center><strong>Admin Chatroom <span class="badge"><?php echo $numme; ?></span></strong></center></div>
  ...
  <input type="text" name="video" id="video" placeholder="Enter the url here...">
	</form>
		<?php
		 $str = (isset($_POST['video']) ? $_POST['video'] : '');
		 $str3=str_replace("watch?v=","embed/",$str);
		 echo "
		<iframe width='430' height='315' src='$str3' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>
		";
		?>
